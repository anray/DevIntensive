...
public class RepositoryDao extends AbstractDao<Repository, Long> {
    ...
    */
    ...
    private Query<Repository> user_MRepositoriesQuery;
    ...
    /** Internal query to resolve the "mRepositories" to-many relationship of User. */
    public List<Repository> _queryUser_MRepositories(String userRemoteId) {
        synchronized (this) {
            if (user_MRepositoriesQuery == null) {
                QueryBuilder<Repository> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.UserRemoteId.eq(null));
                user_MRepositoriesQuery = queryBuilder.build();
            }
        }
        Query<Repository> query = user_MRepositoriesQuery.forCurrentThread();
